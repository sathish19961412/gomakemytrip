...
<head>
	...
	<title>go make yours trips| thailand</title>
	...
	<div class="site wrapper-content">
			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li>Best Visit In Thailand</li>
					</ul>
				</div>
				<h1 class="heading_primary">Best Visit In Thailand</h1></div>
		</div>
        <section>
             <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-center">
                             <h2 class="text-black" style="font-weight:500;">Best Visit In Thailand Places</h2>
                        </div>
                    </div>
                </div>
             </div>
        ...
        <section>
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT*FROM tourslist WHERE country='thailand';");
