	...
	<div class="site wrapper-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-center">
                             <h2 class="text-black" style="font-weight:500;">Best Visit In India Places</h2>
                        </div>
                    </div>
                </div>
             </div>
        ...
        <section>
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT*FROM tourslist WHERE country='india';");
